...
public class TrackNumberStrategy extends AppStrategy {
    ...
    private String pMode; private boolean pPadZero; private String pSeparator;
    ...
    @Override public void loadConfig(Properties props) {
    ...
    public List<ChangeRecord> analyze(List<ChangeRecord> inputRecords, List<File> rootDirs, BiConsumer<Double, String> progressReporter) {
        ...
        for (List<ChangeRecord> group : dirGroups.values()) {
            ...
            if (progressReporter != null) Platform.runLater(() -> progressReporter.accept((double)c/total, "排序目录..."));
        }
        return results;
    }

    private String cleanName(String s) { return s.replaceFirst("^\\d+[.\\s\\-_]*", "").trim(); }
}