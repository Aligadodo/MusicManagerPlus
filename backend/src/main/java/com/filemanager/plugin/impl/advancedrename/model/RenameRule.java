...
public class RenameRule {
    ...
    private RenameActionType actionType;
    private String findStr;
    private String replaceStr;
    private RenameMode extensionProcessMode;

    public RenameRule() {
        this.conditions = new ArrayList<>();
        this.extensionProcessMode = RenameMode.ONLY_FILENAME;
    }
    ...
    public RenameRule(List<RuleCondition> c, RenameActionType a, String f, String r, RenameMode m) {
        this.conditions = c != null ? c : new ArrayList<>();
        this.actionType = a;
        this.findStr = f;
        this.replaceStr = r;
        this.extensionProcessMode = m;
    }
    ...
    public String apply(String s, boolean isDirectory) {
        ...
        String fileName = isDirectory ? s : getFileNameNoneTypeStr(s);
        String typeName = isDirectory ? "" : getFullTypeStr(s);
        String tempName = "";
    ...
    private String getFileNameNoneTypeStr(String fileName) {
        int dot = fileName.lastIndexOf('.');
        return dot > 0 ? fileName.substring(0, dot) : fileName;
    }

    private String getFullTypeStr(String fileName) {
        int dot = fileName.lastIndexOf('.');
    ...
    public RenameActionType getActionType() {
        return actionType;
    }

    public void setActionType(RenameActionType actionType) {
    ...
    public RenameMode getExtensionProcessMode() {
        return extensionProcessMode;
    }

    public void setExtensionProcessMode(RenameMode extensionProcessMode) {
        this.extensionProcessMode = extensionProcessMode;
    }
}